          ...
          <Container maxWidth="lg" fixed>
             <div className={styles.content}>
                <Link className={styles.anchor} href="/dashboard">
                   ...
                   <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 100 100">
                        <g>
                ...
                <div className={styles.ui}>
                   <Link href="/register" className={styles.anchor}>
                      <button className={styles.nav}>register</button>
                   </Link>
