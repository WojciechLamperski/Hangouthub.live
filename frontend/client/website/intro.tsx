          ...
          <Container maxWidth="sm" fixed>
             <div className={styles.wrapper}>
                ...
                <p className={styles.text}>
                   At Hangout Hub you can create high-quality virtual meetings, that let you
                   connect, collaborate, and communicate effortlessly, from anywhere, at any time.
                </p>
                <h4> Join us and transform your digital interactions today! </h4>
